...
import { LayoutDashboard, FolderKanban, LogOut, Globe, Menu, X, Sliders, Settings, Inbox } from "lucide-react"
...
const navItems = [
  ...
  { href: "/admin/contacts", icon: Inbox, label: "Contact Inquiries", exact: true },
  { href: "/admin/settings", icon: Settings, label: "System Settings", exact: true },
    ...
    <>
      ...
      <div className="p-3 sm:p-4 border-t border-white/5 flex-shrink-0">
        <button
          ...
          className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 w-full text-left text-zinc-500 hover:text-red-400 border-l-2 border-transparent hover:border-red-400 hover:bg-red-550/5 transition-all uppercase tracking-[0.15em] sm:tracking-[0.2em] text-[10px] min-h-[48px] cursor-pointer"
        >
          <LogOut size={15} />
          Disconnect Session
        </button>
